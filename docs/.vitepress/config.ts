    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Conditional Widgets', link: '/core/conditional-widgets' },
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'PlayerPrefs', link: '/modules/overview/features/playerprefs' },
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Haptics', link: '/modules/console/features/haptics' },
