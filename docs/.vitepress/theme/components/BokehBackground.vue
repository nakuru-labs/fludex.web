<!-- docs/.vitepress/theme/components/BokehBackground.vue -->
<template>
  <div class="bokeh" aria-hidden="true">
    <div class="bokeh__blob bokeh__blob--1" />
    <div class="bokeh__blob bokeh__blob--2" />
...
.bokeh__blob--4 {
  ...
  top: 45%;
  left: 20%;
  background: rgba(68, 34, 105, 0.16);
  filter: blur(100px);
}
